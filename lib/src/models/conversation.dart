...
class ConversationsList {
  ...
  ConversationsList() {
    this._conversations = [
      ...
      new Conversation(
          ...
          [
            new Chat(
                ...
                '32min ago',
                new User.basic('Carol', 'R. Hansen', 'img/user1.jpg',
                    UserState.available)),
            new Chat(
      ...
      new Conversation(
          ...
          [
            new Chat(
                ...
                '63min ago',
                new User.basic('John', 'R. Whipple', 'img/user1.jpg',
                    UserState.available)),
            new Chat(
                'Can scroll in any direction. ',
                '1hour ago',
      ...
      new Conversation(
          new User.basic(
              'Jordan', 'P. Jeffries', 'img/user0.jpg', UserState.away),
          [
            new Chat(
      ...
      new Conversation(
          ...
          [
            new Chat(
                'Accepts one sliver as content.',
                '45min ago',
                new User.basic('Michele', 'J. Dunn', 'img/user1.jpg',
                    UserState.available)),
      ...
      new Conversation(
          new User.basic(
              'Regina', 'R. Risner', 'img/user1.jpg', UserState.away),
          [
            new Chat(
                'Can scroll in any direction.  ',
                '33min ago',
                new User.basic('Regina', 'R. Risner', 'img/user1.jpg',
                    UserState.available)),
            new Chat('Supports overlapping (AppBars for example). ',
      ...
      new Conversation(
          new User.basic(
              'Patrick', 'B. Scott', 'img/user0.jpg', UserState.busy),
          [
            new Chat(
                'Supports overlapping AppBars for example. ',
                '33min ago',
                new User.basic('Patrick', 'B. Scott', 'img/user1.jpg',
                    UserState.available)),
            new Chat(
